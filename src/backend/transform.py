...
def transform_and_write(rows_by_table: Dict[str, List[Dict]], order: List[str], output_dir: str):
    ...
    for table in order:
        ...
        lines.extend([
            "",
            "-- End of file",
            f"-- Total records inserted: {len(rows_by_table[table])}"
        ])
